...
#import "DUDiskUsageController.h"


@implementation DUDiskUsageController
...
//        [_treeController setContent:_treeDataRoot];
        ...
        _chartData = [[DUFolderChartData alloc] initWithFolder: _scanFolderOperation.folderInfo shareThreshold:5];
...
- (BOOL)outlineView:(NSOutlineView *)outlineView shouldSelectItem:(id)item
{
    ...
    _chartData = [[DUFolderChartData alloc] initWithFolder:selectedTreeItem.folder shareThreshold:5];
